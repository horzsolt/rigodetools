...
public class PriceChecker {
    ...
    public void checkPlaystationProPrice() {
        ...
        try {
            ...
            if ((result1 < basePrice) || (result2 < basePrice) || (result3 < basePrice) || (result4 < basePrice) || (result5 < basePrice)) {
                mailSender.sendMail("EMag: " + result1.toString() + ", Edigital: " + result2.toString() + ", Media: " + result3.toString() + ", argep: " + result4.toString() + ". Telekom: " + result5.toString());
            } else {
                mailSender.sendMail("EMag: " + result1.toString() + ", Edigital: " + result2.toString() + ", Media: " + result3.toString() + ", argep: " + result4.toString() + ". Telekom: " + result5.toString());
            }
